...
for it in 1:max_iter
    ...
    @constraint(OPF, PV_curt[DG in DG_SET, h in HOUR_SET, m in QUARTER_SET], PVC[DG, h,m] == (Pdg_max_vary[DG][h,m]-Pdg[DG, h, m]) )
    # @constraint(OPF, Fairness[DG in DG_SET, h in HOUR_SET, m in QUARTER_SET], PVC[h,m] >= (Pdg_max_vary[DG][h,m]-Pdg[DG, h, m]) )
    ...
    f1 = 1.2315274    # Final PVs - Variable V_break + Max use PV
    f2 = 27.036438    # Final PVs - Variable V_break + Max use PV
