# =============================================================================
# Pareto study — Scenario 4 (variable breakpoints + egalitarian fairness)
#
...
# PV curtailment is allocated by the egalitarian fairness rule (Eq. 37).
#
...
for it in 1:max_iter
    ...
    # -------------------------------- fairness: egalitarian curtailment (Eq. 37)
    # ψ_t >= Pmax - P for every PV unit: the absolute curtailment margin at
    # time t is shared equally across all units
    ...
    f1 = 0.4310611    # η for the egalitarian fairness term (variable breakpoints)
