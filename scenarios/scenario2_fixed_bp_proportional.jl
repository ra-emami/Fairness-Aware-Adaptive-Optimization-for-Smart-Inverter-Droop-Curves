# =============================================================================
# Scenario 2 — Fixed Volt-Var breakpoints + proportional fairness
#
...
# PV curtailment is allocated by the proportional fairness rule (Eq. 38).
#
# Reference:
...
for it in 1:max_iter
    ...
    @variable(OPF, 0 <= fairness_index[HOUR_SET, QUARTER_SET])  # ψ_t (Eq. 38)
    ...
    # ------------------------------- fairness: proportional curtailment (Eq. 38)
    # ψ_t · Pmax >= Pmax - P  (multiply-through form of ψ_t >= (Pmax - P)/Pmax,
    # well defined also when Pmax = 0 at zero irradiance)
    ...
    f1 = 2.9071254    # η for the proportional fairness term (fixed breakpoints)
    f2 = 64.2462993   # η for the voltage-deviation term (fixed breakpoints)
